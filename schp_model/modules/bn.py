...
def _lazy_import_functions():
    global inplace_abn, inplace_abn_sync
    if inplace_abn is None:
        from .functions import inplace_abn as _abn, inplace_abn_sync as _abn_sync
        inplace_abn = _abn
        inplace_abn_sync = _abn_sync
